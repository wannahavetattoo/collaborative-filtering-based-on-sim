...
class ItemBasedCF(object):
    ...
    def myprintf(self):
        f1 = open("/Users/llz/Desktop/itemCF.txt", 'w')
        f = open("/Users/llz/Desktop/movies.txt", "r")
        mydict = dict()
        while 1:
            line = f.readline()
            if not line:
            ...
            for i in strlist:
                ...
                mydict[i]=
            '''
            mydict[strlist[0]] = strlist[1]
        print("write begin",file=sys.stderr)
        ...
        for i, user in enumerate(self.trainset):
            ...
            for j in rec_movies:
                #print(j)
                #print("user:"+user+"--"+j[0]+":"+mydict[j[0]])
                str="user:"+user+"::recommand movied:"+j[0]+":"+mydict[j[0]]+'\n'
                f1.writelines(str)

        print("write done",file=sys.stderr)
        f.close()
        f1.close()
